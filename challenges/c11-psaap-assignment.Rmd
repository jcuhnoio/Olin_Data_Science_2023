...
-   Which model tends to be more accurate? How can you tell from this predicted-vs-actual plot?
    -   (Your response here) In terms of accuracy, from what is visible from the plot, there is not much of a difference, as both models' intervals seem land on the `Predicted T_norm vs Actual T_norm` line.
