...
The opposite of the hypothesis is shown in the graph, where the better the cut of the diamond, the more there are.
...
**Observations**:
- Write your observations here!
The graph shows that there is great variance regardless of the cut. It may be argued that the plot contradicts the hypothsis. However, since the plot does not show characteristics of the variation, it may not be telling the full story.
...
**Observations**:
- Write your observations here!
Since boxplots visualize variance, it helps add confidence that the hypothesis is not true.
...
**Observations**:
- Write your observations here!
There are outliers with the "Fair" cut that has significantly more carats than other cuts.
