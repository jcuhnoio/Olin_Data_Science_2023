...
## Your code here!
error_real <- abs(LIGHTSPEED_VACUUM - LIGHTSPEED_MICHELSON) %>% round(6)
cat("Actual error:", error_real)
```

    ## Actual error: 151.542
...
![](c02-michelson-assignment_files/figure-gfm/q5_visualize-1.png)<!-- -->
...
![](c02-michelson-assignment_files/figure-gfm/q5_visualize-2.png)<!-- -->
